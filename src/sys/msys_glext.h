...
#define NUMFUNCIONES (3+5+1+0+4+12+1+11+15)
...
//me
#define oglMultiTexCoord2fARB         ((PFNGLMULTITEXCOORD2FARBPROC)msys_oglfunc[37])
#define oglUniform2fv				  ((PFNGLUNIFORM2FVPROC)msys_oglfunc[38])
#define oglUniform1f				  ((PFNGLUNIFORM1FPROC)msys_oglfunc[39])
#define oglGenBuffersARB		      ((PFNGLGENBUFFERSARBPROC)msys_oglfunc[40])
#define oglGenFramebuffersEXT	      ((PFNGLGENFRAMEBUFFERSEXTPROC)msys_oglfunc[41])
#define oglGenRenderbuffersEXT         ((PFNGLGENRENDERBUFFERSEXTPROC)msys_oglfunc[42])
#define oglDrawBuffers               ((PFNGLDRAWBUFFERSPROC)msys_oglfunc[43])
#define oglUniform2f				  ((PFNGLUNIFORM2FPROC)msys_oglfunc[44])
#define oglUniform4f				  ((PFNGLUNIFORM4FPROC)msys_oglfunc[45])
#define oglUniform3f				  ((PFNGLUNIFORM3FPROC)msys_oglfunc[46])
#define oglUniform2i				  ((PFNGLUNIFORM2IPROC)msys_oglfunc[47])
#define oglGetUniformBlockIndex		  ((PFNGLGETUNIFORMBLOCKINDEXPROC)msys_oglfunc[48])
#define oglGetActiveUniformBlockiv	  ((PFNGLGETACTIVEUNIFORMBLOCKIVPROC)msys_oglfunc[49])
#define oglGetAttribLocation          ((PFNGLGETATTRIBLOCATIONPROC)msys_oglfunc[50])
#define oglVertexAttribPointer        ((PFNGLVERTEXATTRIBPOINTERPROC)msys_oglfunc[51])
